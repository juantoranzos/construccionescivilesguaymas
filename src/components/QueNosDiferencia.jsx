      ...
      <div className="row justify-content-around ">
        <div className='col-md-3 mb-4'>
          <div className='border border-end-0 border-white shadow-lg p-4'>
            <img src="../public/img/descarga.svg" className="w-100 mb-3" alt="" />
        ...
        <div className='col-md-3 mb-4'>
          <div className='border border-end-0 border-white shadow-lg p-4'>
            <img src="../public/img/conversation.svg" className="w-100 mb-3" alt="" />
        ...
        <div className='col-md-3 mb-4'>
          <div className='border border-white shadow-lg p-4'>
            <img src="../public/img/payment.svg" className="w-100 mb-3" alt="" />
